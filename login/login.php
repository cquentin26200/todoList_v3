...
<div class="container-form">
    <form action="../verification/verif_login.php" method="POST" class="register">
        <h1>S'identifier</h1>
        ...
        <div class="column">
            <input type="password" name="password" id="password" value="<?= isset($_COOKIE["password"]) ? $_COOKIE["password"] : "" ?>">
